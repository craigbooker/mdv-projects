...
(function($) {
	...
	$.csv2table={
		...
		sortNImg : (new Image()).src='./img/icon-loadinfo.gif',         //Dafault sort IMG N

		//sortDImg : (new Image()).src='./img/icon-d-green.gif',   //Dafault sort IMG D
		sortDImg : (new Image()).src='./img/icon-loadinfo.gif',   //Dafault sort IMG D 
 
		//sortAImg : (new Image()).src='./img/icon-a-green.gif',   //Dafault sort IMG A
		sortAImg : (new Image()).src='./img//icon-loadinfo.gif',   //Dafault sort IMG A
